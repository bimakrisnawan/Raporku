...
<head>
    ...
    <!-- style -->
    <link rel="stylesheet" href="{{ asset('mycss/guru/guru_tambah.css') }}">

    <title>Tambah Profil Siswa</title>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <span class="sub-title">Silahkan Isi Form Dibawah Ini Untuk Menambahkan Data Diri Siswa</span>
                </div>
            </div>
            <div class="row form_tambah ">
                <div class="col-md-3"></div>
                <div class="col-md-6">
                    @if($_SESSION["nis_full"] == 1 )
                    <div class="benar_salah">
                        <img src="{{asset('scr/login/pass.png')}}" alt="">
                        <h5>Gagal Daftar,<br /> NIS Siswa Sudah Terdaftar!!!</h5>
                        <a href="/tambah">
                    ...
                    <form method="post" action="/proses_tambah">
                        ...
                        <div class="d-grid gap-2 class_tambah">
                            <button type="submit" class="submit_tambah">Tambah Profil</button>
                        </div>
                    </form>
                    @endif
                </div>
